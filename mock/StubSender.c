...
static unsigned long (*send)(const char* address, const char* content, unsigned long size) = 0;

void Sender_Create(const void *send_function) {
  send = (unsigned long (*)(const char*, const char*, unsigned long)) send_function;
}
